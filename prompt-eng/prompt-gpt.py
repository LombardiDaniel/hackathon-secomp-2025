...
# O cliente OpenAI busca a chave da variável de ambiente OPENAI_API_KEY por padrão.
# Certifique-se de que ela está configurada no seu ambiente.
try:
    client = OpenAI()
except Exception as e:
    print(f"Erro ao inicializar o cliente OpenAI. Verifique se a variável de ambiente OPENAI_API_KEY está definida.")
    print(e)
    exit()

# --- 2. DEFINIÇÃO DO JSON SCHEMA ---
# O schema exato que você forneceu (sem alterações).
JSON_SCHEMA = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://example.com/schemas/roadmap.schema.json",
  "title": "Roadmap",
  "type": "object",
  "required": ["schemaVersion", "id", "title", "modules", "nodes"],
  "properties": {
