...
var (
	...
	AppHostUrl                        string = common.GetEnvVarDefault("APP_HOST_URL", "http://roady.patos.dev/")
	ApiHostUrl                        string = common.GetEnvVarDefault("API_HOST_URL", "http://api.roady.patos.dev/")
